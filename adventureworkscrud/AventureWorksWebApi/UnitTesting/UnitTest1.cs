...
namespace UnitTesting
{
    ...
    public class UnitTest1
    {
        ...
        {
            ProductController productController = new ProductController();
            var productbyidnumber709 = unitOfWork.ProductRepository.Entities.Where(x => x.ProductID == 709).FirstOrDefault();
            var resultGetAll = productController.PutProduct(productbyidnumber709);
        }
